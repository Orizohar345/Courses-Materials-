...
static List listCopy(List list_element)
{
    if(list_element == NULL) return NULL ;
...
static void listDestroy (List list_header)
{
...
AmountSetResult asRegister(AmountSet set, const char* element) {
    ...
    if ((strcmp(header->element, element) == 0))
    {
